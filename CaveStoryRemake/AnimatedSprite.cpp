...
void AnimatedSprite::update(int elapsedTime) {
	...
	if (this->_timeElapsed > this->_timeToUpdate) {
		...
		// If frameindex is not at last index of animation
...
void AnimatedSprite::draw(Graphics &graphics, int x, int y) {
	if (this->_visible) {
		...
		// Indexes the map to get the correct vector for our animation and then indexes
		// vector to get correct rectangle from vector itself
